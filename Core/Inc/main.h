...
/* Private defines -----------------------------------------------------------*/
#define LED_CC1_Pin GPIO_PIN_2
#define LED_CC1_GPIO_Port GPIOA
#define LED_CC2_Pin GPIO_PIN_3
#define LED_CC2_GPIO_Port GPIOA
#define LED_CC3_Pin GPIO_PIN_4
#define LED_CC3_GPIO_Port GPIOA
#define LED_CC4_Pin GPIO_PIN_5
#define LED_CC4_GPIO_Port GPIOA
